...
.login-left {
    color: black;
    /* Optional: Box shadow for the left side */
...
.login-right {
    ...
    justify-content: center;
    align-items: center;
    box-shadow: -4px 0 15px rgba(0, 0, 0, 0.1); /* Optional: Box shadow for the right side */
}
...
/* Your existing CSS... */
        ...
        .outer-wrapper::after, .outer-wrapper::before {
            content: '';
            position: absolute;
            height: calc(100% + 10px); /* Match the wrapper size */
            width: calc(100%);
        ...
        .text-end {
    margin-left: 10px; /* Center align the text */
    margin-top: 10px; /* Optional: Add some spacing above the link */
}
    </style>
</head>
<body>
